...
type TradingListReq struct {
	...
	EquipmentType              string `json:"equipmentType,optional"`              // 箱型规格参数，如 twenty_dry_container, forty_dry_container, forty_high_cube 等
	CommercialTerm             string `json:"commercialTerm,optional"`             // 提箱方式，如 gate_buy, pick_up
	YearOfManufactureRangeFrom int32  `json:"yearOfManufactureRangeFrom,optional"` // 生产年份起步，如 2025
